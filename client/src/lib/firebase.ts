...
const firebaseConfig = {
  ...
  databaseURL: `https://${import.meta.env.VITE_FIREBASE_PROJECT_ID || "seva-emergency"}-default-rtdb.asia-southeast1.firebasedatabase.app/`,
...
// Export needed Firebase DB helpers
